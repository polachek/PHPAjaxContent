<nav class="navbar navbar-expand-lg navbar-light navbar-sports">

  <a class="navbar-brand" href="#" onclick="sectionLoader('sports')">
	<img src="images/sports.png" alt="Casino">
  </a>
